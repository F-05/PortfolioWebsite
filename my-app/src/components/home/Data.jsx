...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Fideris Susanto
          <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <p className="home__description">
          I build full-stack web applications with React, enjoy solving real-world problems,
          and focus on creating reliable, practical solutions across both frontend and backend.
        </p>
